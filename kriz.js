...
//mention
   ...
   var logo = "https://avatars.githubusercontent.com/u/88338865?v=4"
   if (text.includes("919207759062")) {
	   ...
	   kriz.sendMessage(m.chat, {
			...
			contextInfo: {
				externalAdReply: {
					title: "Uᴄʜɪʜᴀ Mᴀᴅᴀʀᴀ",
					body: "Wᴀᴋᴇ Uᴘ Tᴏ Rᴇᴀʟɪᴛʏ",
					mediaType: 2,
					thumbnail: image2,
					mediaUrl: 'https://instagram.com/_viper.x0_?igshid=MDM4ZDc5MmU=',
					sourceUrl: 'https://instagram.com/_viper.x0_?igshid=MDM4ZDc5MmU=',
